...
public class EjemploGenericos {
    public static void main(String[] args) {
        ...
        // El primero lo convierte en una lista y el segundo lo imprime
        nombres.forEach(System.out::println);
        // Imprime los nombres de la lista
    ...
    public static <T extends Cliente & Comparable<T>> List<T> fromArrayToList(T[] c){
        // Hereden de la clase Cliente y las sub-clases de esta
        return Arrays.asList(c);
    }

    public static <T extends Number> List<T> fromArrayToList(T[] c){
        // Solo acepta del tipo Number
        return Arrays.asList(c);
    }

    public static <T, G> List<T> fromArrayToList(T[] c, G[] x){
        // G[] es el tipo y x la variable
        for (G elemento: x){
    ...
    public static void imprimirClientes(List<? extends Cliente> clientes){
        // Podemos pasar cualquier tipo de clientes (incluso padre) con el ? extends
