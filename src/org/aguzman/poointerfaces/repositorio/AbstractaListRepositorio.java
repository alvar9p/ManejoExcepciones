...
public abstract class AbstractaListRepositorio<T extends BaseEntity> implements OrdenablePaginableCrudRepositorio<T>{
    ...
    public T porId(Integer id) throws LecturaAccesoDatoException{
        ...
        if (resultado == null){
            ...
            // Para eliminar registros con el id que no existen
        }
        return resultado;
    }
    ...
    public void crear(T t) throws EscrituraAccesoDatosException {
        ...
        if (this.dataSource.contains(t)){ // Compara por el ID
            throw new RegistroDuplicadoAccesoDatosException("Error, el objeto con el id " +
